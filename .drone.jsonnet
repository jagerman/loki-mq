    ...
    steps: [
        submodules,
        {
            ...
            commands: [
                ...
                'cd ..',
                'mkdir -p /usr/lib/' + (if debarch == 'armhf' then 'arm-linux-gnueabihf' else (if debarch == 'amd64' then 'x86_64' else if debarch == 'i386' then 'i386' else if debarch == 'arm64' then 'aarch64' else if debarch == 'armhf' then 'arm' else 'unknown') + '-linux-gnu') + '/pgm-5.2/include', # Work around broken openpgm pkgconfig
